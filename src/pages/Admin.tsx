...
const Admin = () => {
  ...
  const [newPost, setNewPost] = useState({
    platform: "instagram" as "instagram" | "tiktok" | "facebook" | "x" | "threads",
    post_url: "",
...
CREATE TABLE campaigns (
  ...
  start_date DATE,
  end_date DATE,
  platform TEXT CHECK (platform IN ('instagram', 'tiktok', 'both', 'facebook', 'x', 'threads')),
...
CREATE TABLE best_posts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  platform TEXT NOT NULL CHECK (platform IN ('instagram', 'tiktok', 'facebook', 'x', 'threads')),
              ...
              <QuoteRequestsPanel 
                onAcceptQuote={(quote: QuoteRequest) => {
                  ...
                  setNewCampaign({
                    ...
                    platform: (quote.platform as "instagram" | "tiktok" | "both" | "facebook" | "x" | "threads") || "instagram",
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-primary/20 shadow-elegant">
                  <CardHeader>
                    ...
                    <CardDescription>Destaca tus mejores contenidos de Instagram, TikTok, Facebook, X o Threads</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                    ...
                    <Button 
                      ...
                      onClick={async () => {
                        await addPost(newPost);
                        setNewPost({ platform: 'instagram' as "instagram" | "tiktok" | "facebook" | "x" | "threads", post_url: '', thumbnail: '', views_count: 0 });
                        ...
                        {post.thumbnail ? (
                          ...
                          <div className={`w-full h-full flex items-center justify-center ${
                            post.platform === 'instagram' 
                              ...
                              : post.platform === 'x'
                              ? 'bg-gradient-to-br from-[#000000] to-[#1D9BF0]'
                              : post.platform === 'threads'
                              ? 'bg-gradient-to-br from-[#1C1C1C] to-[#5C5C5C]'
